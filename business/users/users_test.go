...
func TestRegister(t *testing.T) {
	...
	t.Run("Test Case 3 | No Phone", func(t *testing.T) {
		setup()
		userRepository.On("RegisterUser", mock.Anything, mock.Anything, mock.Anything).Return(userDomain, errors.New("no hp belum di isi")).Once() 
		user, err := userService.RegisterUser(context.Background(), users.Domain{
			Phone		:"",
		})
		assert.Error(t, err)
	...
	t.Run("Test Case 4 | No Password", func(t *testing.T) {
